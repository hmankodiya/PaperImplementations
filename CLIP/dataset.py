...
class ImageTextCollator:
    ...
    def __init__(
        ...
        **const_model_kwargs,
        ...
        self.const_model_kwargs = const_model_kwargs
        self.text_collator = DataCollatorWithPadding(
            tokenizer=tokenizer, padding=padding, max_length=max_length,
            pad_to_multiple_of=pad_to_multiple_of, return_tensors=return_tensors
        )
    ...
    def __call__(self, batch):
        ...
        batch_dict.update({"input_ids": batch_dict["input_ids"]})
        batch_dict.update(self.const_model_kwargs)
